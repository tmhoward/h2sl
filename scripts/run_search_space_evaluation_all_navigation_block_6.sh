...
export GROUNDING_EXAMPLES="${ED}/groups/example_0*.xml ${ED}/objects_in_groups/example_0*.xml"

echo "GROUNDING_EXAMPLES:${GROUNDING_EXAMPLES}"
...
export RULE_EXAMPLES="${ED}/groups/rule_example_0*.xml ${ED}/objects_in_groups/rule_example_0*.xml"
...
../build/bin/h2sl-test-generator --num=5 --fr=2 --min_fr=0.7 --max_fr=0.75 ${GROUNDING_EXAMPLES} --output ${SSEOD}/test/
