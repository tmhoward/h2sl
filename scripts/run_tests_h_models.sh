...
# hdcg tests
../build/bin/h2sl-hdcg-test  ../data/training/navigation_corpus/groups/example_00*.xml  ../data/training/navigation_corpus/objects_in_groups/example_00*.xml --sd sdc_hdcg_nav.xml --llm llm_hdcg_nav.xml --debug 1 --beam_width 1
