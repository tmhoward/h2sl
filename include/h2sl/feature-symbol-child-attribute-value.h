/**
 * @file feature-symbol-child-attribute-value.h
...
namespace h2sl {
  /**
   * FeatureSymbolChildAttributeValue class definition
   */
  class FeatureSymbolChildAttributeValue : public Feature {
  public:
  /**
    FeatureSymbolChildAttributeValue default class constructor.

    @brief Default FeatureSymbolChildAttributeValue class constructor.
    @returns              none
  ...
  */
  ...
  /**
    ...
    @brief FeatureSymbolChildAttributeValue class constructor from an XMLElement.
    @param[in]  root      xml element
    @returns              none
    @throws               no expected throws
  */
  explicit FeatureSymbolChildAttributeValue( const tinyxml2::XMLElement* root );

  /**
    Default FeatureSymbolChildAttributeValue class copy constructor.
  */
  FeatureSymbolChildAttributeValue( const FeatureSymbolChildAttributeValue& other ) = default;

  /**
    Default FeatureSymbolChildAttributeValue class move constructor.
  */
  FeatureSymbolChildAttributeValue( FeatureSymbolChildAttributeValue&& other ) = default;

  /**
    Default FeatureSymbolChildAttributeValue class destructor.
  */
  virtual ~FeatureSymbolChildAttributeValue() = default;

  /**
    Default FeatureSymbolChildAttributeValue class copy assignment operator.
  */
  FeatureSymbolChildAttributeValue&
  operator=( const FeatureSymbolChildAttributeValue& other ) = default;

  /**
    Default FeatureSymbolChildAttributeValue class move assignment operator.
  */
  FeatureSymbolChildAttributeValue&
  operator=( FeatureSymbolChildAttributeValue&& other ) = default;
  ...
  */
  ...
  /**
      This method imports a FeatureSymbolChildAttributeValue from a tinyxml2 element.

      @brief This method imports a FeatureSymbolChildAttributeValue from a tinyxml2 element.
  ...
  */
  ...
  /**
      This method imports a FeatureSymbolChildAttributeValue from a json formatted string.

      @brief This method imports a FeatureSymbolChildAttributeValue from a json formatted string.
  ...
  */
  ...
  /**
      This method imports a FeatureSymbolChildAttributeValue from a json value.

      @brief This method imports a FeatureSymbolChildAttributeValue from a json value.
  ...
  */
  ...
  /**
      This method exports a FeatureSymbolChildAttributeValue to a tinyxml2 document.

      @brief This method exports a FeatureSymbolChildAttributeValue to a tinyxml2 document.
  ...
  */
  ...
  /**
      This method exports a FeatureSymbolChildAttributeValue to a json formatted string.

      @brief This method exports a FeatureSymbolChildAttributeValue to a json formatted string
  ...
  */
  ...
  /**
      This method exports a FeatureSymbolChildAttributeValue to a json value.

      @brief This method exports a FeatureSymbolChildAttributeValue to a json value.
  ...
  */
  ...
  /**
      ...
      @brief FeatureSymbolChildAttributeValue class ostream operator
