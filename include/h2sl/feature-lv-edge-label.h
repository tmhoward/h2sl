...
namespace h2sl {
  /**
   * FeatureLVEdgeLabel class definition
   */
  class FeatureLVEdgeLabel : public Feature {
  public:
  /**
    FeatureLVEdgeLabel default class constructor.

    @brief Default FeatureLVEdgeLabel class constructor.
    @returns              none
    @throws               no expected throws
  */
  explicit FeatureLVEdgeLabel( const std::string& lvTypeArg = "", const std::string& edgeLabelArg = "" );

  /**
    FeatureLVEdgeLabel class constructor from an XMLElement.

    @brief FeatureLVEdgeLabel class constructor from an XMLElement.
    @param[in]  root      xml element
    @returns              none
    @throws               no expected throws
  */
  explicit FeatureLVEdgeLabel( const tinyxml2::XMLElement* root );

  /**
    Default FeatureLVEdgeLabel class copy constructor.
  */
  FeatureLVEdgeLabel( const FeatureLVEdgeLabel& other ) = default;

  /**
    Default FeatureLVEdgeLabel class move constructor.
  */
  FeatureLVEdgeLabel( FeatureLVEdgeLabel&& other ) = default;

  /**
    Default FeatureLVEdgeLabel class destructor.
  */
  virtual ~FeatureLVEdgeLabel() = default;

  /**
    Default FeatureLVEdgeLabel class copy assignment operator.
  */
  FeatureLVEdgeLabel& operator=( const FeatureLVEdgeLabel& other ) = default;

  /**
    Default FeatureLVEdgeLabel class move assignment operator.
  */
  FeatureLVEdgeLabel& operator=( FeatureLVEdgeLabel&& other ) = default;
  ...
  */
  ...
  /**
      This method imports a FeatureLVEdgeLabel from a tinyxml2 element.

      @brief This method imports a FeatureLVEdgeLabel from a tinyxml2 element.
  ...
  */
  ...
  /**
      This method imports a FeatureLVEdgeLabel from a json formatted string.

      @brief This method imports a FeatureLVEdgeLabel from a json formatted string.
  ...
  */
  ...
  /**
      This method imports a FeatureLVEdgeLabel from a json value.

      @brief This method imports a FeatureLVEdgeLabel from a json value.
  ...
  */
  ...
  /**
      This method exports a FeatureLVEdgeLabel to a tinyxml2 document.

      @brief This method exports a FeatureLVEdgeLabel to a tinyxml2 document.
  ...
  */
  ...
  /**
      This method exports a FeatureLVEdgeLabel to a json formatted string.

      @brief This method exports a FeatureLVEdgeLabel to a json formatted string.
  ...
  */
  ...
  /**
      This method exports a FeatureLVEdgeLabel to a json value.

      @brief This method exports a FeatureLVEdgeLabel to a json value.
  ...
  */
  ...
  /**
      ...
      @brief FeatureLVEdgeLabel class ostream operator
