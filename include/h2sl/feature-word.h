...
namespace h2sl {
  /**
   * FeatureWord class definition
   */
  class FeatureWord : public Feature {
  public:
  /**
      FeatureWord default class constructor.

      @brief Default FeatureWord class constructor.
      @returns              none
      @throws               no expected throws
  */
  FeatureWord( const std::string& posArg = "", const std::string& textArg = "" );

  /**
      FeatureWord class constructor from an XMLElement.

      @brief FeatureWord class constructor from an XMLElement.
      @param[in]  root      xml element
      @returns              none
      @throws               no expected throws
  */
  explicit FeatureWord( const tinyxml2::XMLElement* root );

  /**
    Default copy constructor for h2sl::FeatureWord
  */
  FeatureWord( const FeatureWord& other ) = default;

  /**
    Default move constructor for h2sl::FeatureWord
  */
  FeatureWord( FeatureWord&& other ) = default;

  /**
    Default destructor for h2sl::FeatureWord
  */
  virtual ~FeatureWord() = default;

  /**
    Default assignment operator for h2sl::FeatureWord
  */
  FeatureWord& operator=( const FeatureWord& other ) = default;

  /**
    Default move assignment operator for h2sl::FeatureWord
  */
  FeatureWord& operator=( FeatureWord&& other ) = default;
  ...
  */
  ...
  /**
      This method imports a FeatureWord from a tinyxml2 element.

      @brief This method imports a FeatureWord from a tinyxml2 element.
  ...
  */
  ...
  /**
      This method imports a FeatureWord from a json formatted string.

      @brief This method imports a FeatureWord from a json formatted string.
  ...
  */
  ...
  /**
      This method imports a FeatureWord from a json value.

      @brief This method imports a FeatureWord from a json value.
  ...
  */
  ...
  /**
      This method exports a FeatureWord to a tinyxml2 document.

      @brief This method exports a FeatureWord to a tinyxml2 document.
  ...
  */
  ...
  /**
      This method exports a FeatureWord to a json formatted string.

      @brief This method exports a FeatureWord to a json formatted string
  ...
  */
  ...
  /**
      This method exports a FeatureWord to a json value.

      @brief This method exports a FeatureWord to a json value.
  ...
  */
  ...
  /**
      ...
      @brief FeatureWord class ostream operator
