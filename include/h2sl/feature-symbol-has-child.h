/**
 * @file feature-symbol-has-child.h
...
namespace h2sl {
  /**
   * FeatureSymbolHasChild class definition
   */
  class FeatureSymbolHasChild : public Feature {
  public:
  /**
  ...
  */
  ...
  /**
      ...
      @brief FeatureSymbolHasChild class constructor from an XMLElement.
      @param[in]  root      xml element
      @returns              none
      @throws               no expected throws
  */
  explicit FeatureSymbolHasChild( const tinyxml2::XMLElement* root );

  /**
    Default FeatureSymbolHasChild class copy constructor.
  */
  FeatureSymbolHasChild( const FeatureSymbolHasChild& other ) = default;

  /**
    Default FeatureSymbolHasChild class move constructor.
  */
  FeatureSymbolHasChild( FeatureSymbolHasChild&& other ) = default;

  /**
    Default FeatureSymbolHasChild class destructor.
  */
  virtual ~FeatureSymbolHasChild() = default;

  /**
    Default FeatureSymbolHasChild class assignment operator.
  */
  FeatureSymbolHasChild& operator=( const FeatureSymbolHasChild& other ) = default;

  /**
    Default FeatureSymbolHasChild class move assignment operator.
  */
  FeatureSymbolHasChild& operator=( FeatureSymbolHasChild&& other ) = default;
  ...
  */
  ...
  /**
      This method imports a FeatureSymbolHasChild from a tinyxml2 element.

      @brief This method imports a FeatureSymbolHasChild from a tinyxml2 element.
  ...
  */
  ...
  /**
      This method imports a FeatureSymbolHasChild from a json formatted string.

      @brief This method imports a FeatureSymbolHasChild from a json formatted string.
  ...
  */
  ...
  /**
      This method imports a FeatureSymbolHasChild from a json value.

      @brief This method imports a FeatureSymbolHasChild from a json value.
  ...
  */
  ...
  /**
      This method exports a FeatureSymbolHasChild to a tinyxml2 document.

      @brief This method exports a FeatureSymbolHasChild to a tinyxml2 document.
  ...
  */
  ...
  /**
      This method exports a FeatureSymbolHasChild to a json formatted string.

      @brief This method exports a FeatureSymbolHasChild to a json formatted string
  ...
  */
  ...
  /**
      This method exports a FeatureSymbolHasChild to a json value.

      @brief This method exports a FeatureSymbolHasChild to a json value.
  ...
  */
  ...
  /**
      ...
      @brief FeatureSymbolHasChild class ostream operator
