/**
 * @file feature-symbol-attribute-value.h
...
namespace h2sl {
  /**
   * FeatureSymbolAttributeValue class definition
   */
  class FeatureSymbolAttributeValue : public Feature {
  public:
  /**
    FeatureSymbolAttributeValue default class constructor.

    @brief Default FeatureSymbolAttributeValue class constructor.
    ...
    @param[in]    attributeValueArg The expected value of the attribute
    @param[in]    invertArg         A flag indicating whether to use the inverse of the feature
    @returns                        none
    @throws                         no expected throws
  */
  FeatureSymbolAttributeValue( const std::string& symbolTypeArg = "",
  ...
  /**
    ...
    @brief FeatureSymbolAttributeValue class constructor from an XMLElement.
    @param[in]  root      xml element
    @returns              none
    @throws               no expected throws
  */
  explicit FeatureSymbolAttributeValue( const tinyxml2::XMLElement* root );

  /**
    Default FeatureSymbolAttributeValue class copy constructor.
  */
  FeatureSymbolAttributeValue( const FeatureSymbolAttributeValue& other ) = default;

  /**
    Default FeatureSymbolAttributeValue class move constructor.
  */
  FeatureSymbolAttributeValue( FeatureSymbolAttributeValue&& other ) = default;

  /**
    Default FeatureSymbolAttributeValue class destructor.
  */
  virtual ~FeatureSymbolAttributeValue() = default;

  /**
    Default FeatureSymbolAttributeValue class copy assignment operator.
  */
  FeatureSymbolAttributeValue& operator=( const FeatureSymbolAttributeValue& other ) = default;

  /**
    Default FeatureSymbolAttributeValue class move assignment operator.
  */
  FeatureSymbolAttributeValue& operator=( FeatureSymbolAttributeValue&& other ) = default;
  ...
  */
  ...
  /**
      This method imports a FeatureSymbolAttributeValue from a tinyxml2 element.

      @brief This method imports a FeatureSymbolAttributeValue from a tinyxml2 element.
  ...
  */
  ...
  /**
      This method imports a FeatureSymbolAttributeValue from a json formatted string.

      @brief This method imports a FeatureSymbolAttributeValue from a json formatted string.
  ...
  */
  ...
  /**
      This method imports a FeatureSymbolAttributeValue from a json value.

      @brief This method imports a FeatureSymbolAttributeValue from a json value.
  ...
  */
  ...
  /**
      This method exports a FeatureSymbolAttributeValue to a tinyxml2 document.

      @brief This method exports a FeatureSymbolAttributeValue to a tinyxml2 document.
  ...
  */
  ...
  /**
      This method exports a FeatureSymbolAttributeValue to a json formatted string.

      @brief This method exports a FeatureSymbolAttributeValue to a json formatted string
  ...
  */
  ...
  /**
      This method exports a FeatureSymbolAttributeValue to a json value.

      @brief This method exports a FeatureSymbolAttributeValue to a json value.
  ...
  */
  ...
  /**
      ...
      @brief FeatureSymbolAttributeValue class ostream operator
