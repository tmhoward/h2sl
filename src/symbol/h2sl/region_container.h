...
namespace h2sl {
  ...
  public:
    ...
    inline std::string& type( void ){ return get_prop< std::string >( _properties, "spatial_relation_type" ); };
    inline const std::string& type( void )const{ return get_prop< std::string >( _properties, "spatial_relation_type" ); };
