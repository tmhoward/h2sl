...
namespace h2sl {
  ...
  public:
    ...
    Constraint( const std::string& constraintType = "na", const std::string& payload = "na", const std::string& payloadRelation = "na", const std::string& reference = "na", const std::string& referenceRelation = "na" );
