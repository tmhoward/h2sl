...
int main( int argc, char* argv[] ){
  ...
  if (vm.count("input")) {
    std::cout << "reading feature_pool from \"" << vm["input"].as<std::string>() << "\"" << std::endl;
    feature_pool.from_file(vm["input"].as<std::string>());
  }

  std::cout << feature_pool << std::endl;
