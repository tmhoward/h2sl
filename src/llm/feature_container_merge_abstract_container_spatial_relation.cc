/**
 * @file feature_container_merge_abstract_container_spatial_relation.cc
 *
 * @brief
 *
...
/**
 * Feature_Container_Merge_Abstract_Container_Spatial_Relation class constructor
 */
Feature_Container_Merge_Abstract_Container_Spatial_Relation::
Feature_Container_Merge_Abstract_Container_Spatial_Relation( const bool& invert,
...
Feature_Container_Merge_Abstract_Container_Spatial_Relation::
Feature_Container_Merge_Abstract_Container_Spatial_Relation( xmlNodePtr root ) : Feature() {
...
/**
 * Feature_Container_Merge_Abstract_Container_Spatial_Relation class destructor
 */
Feature_Container_Merge_Abstract_Container_Spatial_Relation::
~Feature_Container_Merge_Abstract_Container_Spatial_Relation() {
...
/**
 * Feature_Container_Merge_Abstract_Container_Spatial_Relation class copy constructor
 */
Feature_Container_Merge_Abstract_Container_Spatial_Relation::
Feature_Container_Merge_Abstract_Container_Spatial_Relation( const Feature_Container_Merge_Abstract_Container_Spatial_Relation& other ) : Feature( other ) {
    
}

/**
 * Feature_Container_Merge_Abstract_Container_Spatial_Relation class assignment operator
 */
Feature_Container_Merge_Abstract_Container_Spatial_Relation&
Feature_Container_Merge_Abstract_Container_Spatial_Relation::
operator=( const Feature_Container_Merge_Abstract_Container_Spatial_Relation& other ) {
      ...
      if( ( abstract_container_child.first != NULL ) && ( abstract_container_child.second != NULL ) && ( spatial_relation_child.first != NULL ) && ( spatial_relation_child.second != NULL ) ){
        if( ( abstract_container_child.first->min_word_order() < spatial_relation_child.first->min_word_order() ) ){
          if( spatial_relation_child.second->spatial_relation_type() == spatial_relation_type() ){
            ...
            if( sorted_objects.size() == abstract_container_child.second->number() ){
...
/**
 * exports the Feature_Container_Merge_Abstract_Container_Spatial_Relation class to an XML file
 */
void
Feature_Container_Merge_Abstract_Container_Spatial_Relation::
to_xml( xmlDocPtr doc, xmlNodePtr root )const{
    xmlNodePtr node = xmlNewDocNode( doc, NULL, ( xmlChar* )( "feature_container_merge_abstract_container_spatial_relation" ), NULL );
...
/**
 * imports the Feature_Container_Merge_Abstract_Container_Spatial_Relation class from an XML file
 */
void
Feature_Container_Merge_Abstract_Container_Spatial_Relation::
...
namespace h2sl {
    /**
     * Feature_Container_Merge_Abstract_Container_Spatial_Relation class ostream operator
     */
    ostream&
    operator<<( ostream& out,
               const Feature_Container_Merge_Abstract_Container_Spatial_Relation& other ) {
      out << "Feature_Container_Merge_Abstract_Container_Spatial_Relation:( invert:(" << other.invert() << ") spatial_relation_type:(" << other.spatial_relation_type() << ") sorting_key:(" << other.sorting_key() << "))";  
      return out;
    }
