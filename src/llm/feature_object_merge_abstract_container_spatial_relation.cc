...
Feature_Object_Merge_Abstract_Container_Spatial_Relation( const bool& invert ) : Feature( invert ) {
...
namespace h2sl {
    ...
    operator<<( ostream& out,
      ...
      out << "class:\"Feature_Object_Merge_Abstract_Container_Spatial_Relation\" ";  
      return out;
    }
