/**
 * @file feature_min_x_abstract_container.cc
 *
 * @brief
 *
...
/**
 * Feature_Min_X_Abstract_Container class constructor
 */
Feature_Min_X_Abstract_Container::
Feature_Min_X_Abstract_Container( const bool& invert,
...
/**
 * Feature_Min_X_Abstract_Container class copy constructor
 */
Feature_Min_X_Abstract_Container::
Feature_Min_X_Abstract_Container( const Feature_Min_X_Abstract_Container& other ) : Feature( other ),
                                                              _relation_type( other._relation_type ) {

}

/**
 * Feature_Min_X_Abstract_Container class destructor
 */
Feature_Min_X_Abstract_Container::
~Feature_Min_X_Abstract_Container() {
...
/** 
 * Feature_Min_X_Abstract_Container class assignment operator
 */
Feature_Min_X_Abstract_Container&
Feature_Min_X_Abstract_Container::
operator=( const Feature_Min_X_Abstract_Container& other ){
    ...
    if( abstract_container_child != NULL ){
      if( spatial_relation_child != NULL ){
        if( spatial_relation_child->relation_type() == _relation_type ){
          ...
          it  = world->min_x_sorted_objects().find( abstract_container_child->type() );
...
/** 
 * imports the Feature_Min_X_Abstract_Container class from an XML file
 */
void
Feature_Min_X_Abstract_Container::
    ...
    if( root->type == XML_ELEMENT_NODE ){
      ...
      for( l1 = root->children; l1; l1 = l1->next ){
        if( l1->type == XML_ELEMENT_NODE ){
          if( xmlStrcmp( l1->name, ( const xmlChar* )( "feature_min_x_abstract_container" ) ) == 0 ){
            from_xml( l1 );
          }
        }
      }
...
/** 
 * imports the Feature_Min_X_Abstract_Container class from an XML node pointer
 */
void
Feature_Min_X_Abstract_Container::
...
/**
 * exports the Feature_Min_X_Abstract_Container class to an XML file
 */
void
Feature_Min_X_Abstract_Container::
...
/**
 * exports the Feature_Min_X_Abstract_Container class to an XML node pointer
 */
void
Feature_Min_X_Abstract_Container::
to_xml( xmlDocPtr doc,
        xmlNodePtr root )const{
  xmlNodePtr node = xmlNewDocNode( doc, NULL, ( xmlChar* )( "feature_min_x_abstract_container" ), NULL );
...
namespace h2sl {
  /** 
   * Feature_Min_X_Abstract_Container class ostream operator
   */
  ostream&
  operator<<( ostream& out,
              const Feature_Min_X_Abstract_Container& other ){
    out << "class:\"Feature_Min_X_Abstract_Container\" ";
