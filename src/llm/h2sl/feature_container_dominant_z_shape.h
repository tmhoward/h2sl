/**
 * @file feature_container_dominant_z_shape.h
 * 
 * @brief
 * 
...
#ifndef H2SL_FEATURE_CONTAINER_DOMINANT_Z_SHAPE_H
#define H2SL_FEATURE_CONTAINER_DOMINANT_Z_SHAPE_H
...
namespace h2sl {
  /**
   * Feature_Container_Dominant_Z_Shape class definition
   */
  class Feature_Container_Dominant_Z_Shape : public Feature {
  public:
    Feature_Container_Dominant_Z_Shape( const bool& invert = false, 
    ...
    Feature_Container_Dominant_Z_Shape( const Feature_Container_Dominant_Z_Shape& other );
    virtual ~Feature_Container_Dominant_Z_Shape();
    Feature_Container_Dominant_Z_Shape& operator=( const Feature_Container_Dominant_Z_Shape& other );
    ...
    static bool container_expresses_dominant_z_structure( const std::vector < Grounding* >& container, 
                                                          const double& model_deviation_tolerance = 0.1, 
                                                          const double& adjacent_distance_tolerance = 0.1, 
                                                          const unsigned int& min_num_elements = 2 );
 ...
 protected:
   ...
   */
  std::ostream& operator<<( std::ostream& out, const Feature_Container_Dominant_Z_Shape& other );
}

#endif /* H2SL_FEATURE_CONTAINER_DOMINANT_Z_SHAPE_H */
