/**
 * @file feature_object_merge_abstract_container_region_container.h
 *
 * @brief
 *
...
#ifndef H2SL_FEATURE_OBJECT_MERGE_ABSTRACT_CONTAINER_REGION_CONTAINER_H
#define H2SL_FEATURE_OBJECT_MERGE_ABSTRACT_CONTAINER_REGION_CONTAINER_H
...
namespace h2sl {
    ...
    std::ostream& operator<<( std::ostream& out, const Feature_Object_Merge_Abstract_Container_Region_Container& other );
}

#endif /* H2SL_FEATURE_OBJECT_MERGE_ABSTRACT_CONTAINER_REGION_CONTAINER_H */
