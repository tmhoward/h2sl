...
#ifndef H2SL_FEATURE_OBJECT_MERGE_OBJECT_CONTAINER_H
#define H2SL_FEATURE_OBJECT_MERGE_OBJECT_CONTAINER_H
...
namespace h2sl {
     ...
     */
    class Feature_Object_Merge_Object_Container: public Feature {
    public:
        Feature_Object_Merge_Object_Container( const bool& invert = false );
        virtual ~Feature_Object_Merge_Object_Container();
        Feature_Object_Merge_Object_Container( const Feature_Object_Merge_Object_Container& other );
        Feature_Object_Merge_Object_Container& operator=( const Feature_Object_Merge_Object_Container& other );
    ...
    std::ostream& operator<<( std::ostream& out, const Feature_Object_Merge_Object_Container& other );
}

#endif /* H2SL_FEATURE_OBJECT_MERGE_OBJECT_CONTAINER_H */
