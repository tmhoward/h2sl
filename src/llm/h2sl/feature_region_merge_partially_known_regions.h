/**
 * @file    feature_region_merge_partially_known_regions.h
...
#ifndef H2SL_FEATURE_REGION_MERGE_PARTIALLY_KNOWN_REGIONS_H
#define H2SL_FEATURE_REGION_MERGE_PARTIALLY_KNOWN_REGIONS_H
...
namespace h2sl {
  class Feature_Region_Merge_Partially_Known_Regions: public Feature {
  public:
    Feature_Region_Merge_Partially_Known_Regions( const bool& invert = false );
    virtual ~Feature_Region_Merge_Partially_Known_Regions();
  ...
  std::ostream& operator<<( std::ostream& out, const Feature_Region_Merge_Partially_Known_Regions& other );
}

#endif /* H2SL_FEATURE_REGION_MERGE_PARTIALLY_KNOWN_REGIONS_H */
