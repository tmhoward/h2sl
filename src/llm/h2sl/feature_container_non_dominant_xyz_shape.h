/**
 * @file feature_container_non_dominant_xyz_shape.h
 * 
 * @brief
 * 
...
#define H2SL_FEATURE_CONTAINER_NON_DOMINANT_XYZ_SHAPE_H
...
namespace h2sl {
  /**
   * Feature_Container_Non_Dominant_XYZ_Shape class definition
   */
  class Feature_Container_Non_Dominant_XYZ_Shape : public Feature {
  public:
    Feature_Container_Non_Dominant_XYZ_Shape( const bool& invert = false, 
    ...
    Feature_Container_Non_Dominant_XYZ_Shape( const Feature_Container_Non_Dominant_XYZ_Shape& other );
    virtual ~Feature_Container_Non_Dominant_XYZ_Shape();
    Feature_Container_Non_Dominant_XYZ_Shape& operator=( const Feature_Container_Non_Dominant_XYZ_Shape& other );
    ...
    // Main structure finding non-dominant structure.
    static bool container_expresses_non_dominant_xyz_structure( const std::vector < Grounding* >& container, 
                                                                const double& model_deviation_tolerance = 0.1, 
                                                                const double& adjacent_distance_tolerance = 0.1, 
                                                               const unsigned int& min_num_elements = 2 );
 ...
 protected:
   ...
   */
  std::ostream& operator<<( std::ostream& out, const Feature_Container_Non_Dominant_XYZ_Shape& other );
}

#endif /* H2SL_FEATURE_CONTAINER_NON_DOMINANT_XYZ_SHAPE_H */
