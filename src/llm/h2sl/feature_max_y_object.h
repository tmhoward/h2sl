...
#ifndef H2SL_FEATURE_MAX_Y_OBJECT_H
#define H2SL_FEATURE_MAX_Y_OBJECT_H
...
namespace h2sl {
  /**
   * Feature_Max_Y_Object class definition
   */
  class Feature_Max_Y_Object : public Feature {
  public:
    Feature_Max_Y_Object( const bool& invert = false );
    Feature_Max_Y_Object( const Feature_Max_Y_Object& other );
    virtual ~Feature_Max_Y_Object();
    Feature_Max_Y_Object& operator=( const Feature_Max_Y_Object& other );
   ...
   */
  std::ostream& operator<<( std::ostream& out, const Feature_Max_Y_Object& other );
}

#endif /* H2SL_FEATURE_MAX_Y_OBJECT_H */
