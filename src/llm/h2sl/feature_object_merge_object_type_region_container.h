/**
 * @file feature_object_merge_object_type_region_container.h
 *
 * @brief
 *
...
#ifndef H2SL_FEATURE_OBJECT_MERGE_OBJECT_TYPE_REGION_CONTAINER_H
#define H2SL_FEATURE_OBJECT_MERGE_OBJECT_TYPE_REGION_CONTAINER_H
...
namespace h2sl {
     ...
     */
    class Feature_Object_Merge_Object_Type_Region_Container: public Feature {
    public:
        Feature_Object_Merge_Object_Type_Region_Container( const bool& invert = false, const std::string& sortingKey = "na", const std::string& spatialRelationType = "na" );
        Feature_Object_Merge_Object_Type_Region_Container( xmlNodePtr root );
        virtual ~Feature_Object_Merge_Object_Type_Region_Container();
        Feature_Object_Merge_Object_Type_Region_Container( const Feature_Object_Merge_Object_Type_Region_Container& other );
        Feature_Object_Merge_Object_Type_Region_Container& operator=( const Feature_Object_Merge_Object_Type_Region_Container& other );
    ...
    std::ostream& operator<<( std::ostream& out, const Feature_Object_Merge_Object_Type_Region_Container& other );
}

#endif /* H2SL_FEATURE_OBJECT_MERGE_OBJECT_TYPE_REGION_CONTAINER_H */
