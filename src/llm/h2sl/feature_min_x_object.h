...
#ifndef H2SL_FEATURE_MIN_X_OBJECT_H
#define H2SL_FEATURE_MIN_X_OBJECT_H
...
namespace h2sl {
  /**
   * Feature_Min_X_Object class definition
   */
  class Feature_Min_X_Object : public Feature {
  public:
    Feature_Min_X_Object( const bool& invert = false );
    Feature_Min_X_Object( const Feature_Min_X_Object& other );
    virtual ~Feature_Min_X_Object();
    Feature_Min_X_Object& operator=( const Feature_Min_X_Object& other );
   ...
   */
  std::ostream& operator<<( std::ostream& out, const Feature_Min_X_Object& other );
}

#endif /* H2SL_FEATURE_MIN_X_OBJECT_H */
