...
#ifndef H2SL_FEATURE_OBJECT_MERGE_ABSTRACT_CONTAINER_SPATIAL_RELATION_H
#define H2SL_FEATURE_OBJECT_MERGE_ABSTRACT_CONTAINER_SPATIAL_RELATION_H
...
namespace h2sl {
    ...
    std::ostream& operator<<( std::ostream& out, const Feature_Object_Merge_Abstract_Container_Spatial_Relation& other );
}
