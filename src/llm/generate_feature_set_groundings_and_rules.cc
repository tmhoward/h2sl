/**
 * @file generate_feature_set_groundings_and_rules.cc
 *
 * @brief
 *
...
main( int argc,
  ...
  symbol_dictionary_groundings->from_xml( args.symbol_dictionary_groundings_arg );  
  ...
  map< string, vector< string > >::const_iterator it_class_names = symbol_dictionary_groundings->class_names().find( it_grammar_terminals->first );
  if( find( it_class_names->second.begin(), it_class_names->second.end(), "object" ) != it_class_names->second.end() ){
    ...
    // object symbols
    map< string, vector< string > >::const_iterator it_object_types = symbol_dictionary_groundings->string_types().find( "object_type" );
    if( it_object_types != symbol_dictionary_groundings->string_types().end() ){
  ...
  if( find( it_class_names->second.begin(), it_class_names->second.end(), "constraint" ) != it_class_names->second.end() ){
    ...
    // constraint symbols
    map< string, vector< string > >::const_iterator it_constraint_types = symbol_dictionary_groundings->string_types().find( "constraint_type" );
    if( it_constraint_types != symbol_dictionary_groundings->string_types().end() ){
    ...
    feature_set->feature_products().back()->feature_groups().back().push_back( new Feature_Grounding_String_Property_Value_Matches_Child_String_Property_Value( false, "constraint", "reference", "object", "id" ) );
    feature_set->feature_products().back()->feature_groups().back().push_back( new Feature_Grounding_String_Property_Value_Matches_Child_String_Property_Value( true, "constraint", "reference", "object", "id" ) );
    ...
    map< string, vector< string > >::const_iterator it_constraint_payload_type_types = symbol_dictionary_groundings->string_types().find( "constraint_payload_type" );
  ...
  if( find( it_class_names->second.begin(), it_class_names->second.end(), "container" ) != it_class_names->second.end() ){
    ...
    map< string, vector< string > >::const_iterator it_container_types = symbol_dictionary_groundings->string_types().find( "container_type" );
    if( it_container_types != symbol_dictionary_groundings->string_types().end() ){
  ...
  if( find( it_class_names->second.begin(), it_class_names->second.end(), "rule_spatial_relation" ) != it_class_names->second.end() ){
    ...
    // spatial relation symbols
    map< string, vector< string > >::const_iterator it_spatial_relation_types = symbol_dictionary_rules->string_types().find( "spatial_relation_type" );
    if( it_spatial_relation_types != symbol_dictionary_rules->string_types().end() ){
      for( vector< string >::const_iterator it_spatial_relation_type = it_spatial_relation_types->second.begin(); it_spatial_relation_type != it_spatial_relation_types->second.end(); it_spatial_relation_type++ ){
  ...
  if( find( it_class_names->second.begin(), it_class_names->second.end(), "rule_object_type" ) != it_class_names->second.end() ){
    ...
    map< string, vector< string > >::const_iterator it_object_types = symbol_dictionary_rules->string_types().find( "object_type" );
    if( it_object_types != symbol_dictionary_rules->string_types().end() ){
      for( vector< string >::const_iterator it_object_type = it_object_types->second.begin(); it_object_type != it_object_types->second.end(); it_object_type++ ){
  ...
  if( find( it_class_names->second.begin(), it_class_names->second.end(), "rule_object_color" ) != it_class_names->second.end() ){
    ...
    map< string, vector< string > >::const_iterator it_object_colors = symbol_dictionary_rules->string_types().find( "object_color" );
    if( it_object_colors != symbol_dictionary_rules->string_types().end() ){
      for( vector< string >::const_iterator it_object_color = it_object_colors->second.begin(); it_object_color != it_object_colors->second.end(); it_object_color++ ){
  ...
  if( find( it_class_names->second.begin(), it_class_names->second.end(), "rule_constraint_type" ) != it_class_names->second.end() ){
    ...
    map< string, vector< string > >::const_iterator it_constraint_types = symbol_dictionary_rules->string_types().find( "constraint_type" );
    if( it_constraint_types != symbol_dictionary_rules->string_types().end() ){
      for( vector< string >::const_iterator it_constraint_type = it_constraint_types->second.begin(); it_constraint_type != it_constraint_types->second.end(); it_constraint_type++ ){
  ...
  if( find( it_class_names->second.begin(), it_class_names->second.end(), "rule_constraint_payload_type" ) != it_class_names->second.end() ){
    ...
    map< string, vector< string > >::const_iterator it_constraint_payload_types = symbol_dictionary_rules->string_types().find( "constraint_payload_type" );
    if( it_constraint_payload_types != symbol_dictionary_rules->string_types().end() ){
  ...
  if( find( it_class_names->second.begin(), it_class_names->second.end(), "rule_constraint_reference_type" ) != it_class_names->second.end() ){
    ...
    map< string, vector< string > >::const_iterator it_constraint_reference_types = symbol_dictionary_rules->string_types().find( "constraint_reference_type" );
    if( it_constraint_reference_types != symbol_dictionary_rules->string_types().end() ){
