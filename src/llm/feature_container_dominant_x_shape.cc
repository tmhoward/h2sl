/**
 * @file feature_container_dominant_x_shape.cc
 *
 * @brief
 *
...
/**
 * Feature_Container_Dominant_X_Shape class constructor
 */
Feature_Container_Dominant_X_Shape::
Feature_Container_Dominant_X_Shape( const bool& invert, 
...
/** 
 * Feature_Container_Dominant_X_Shape class copy constructor
 */ 
Feature_Container_Dominant_X_Shape::
Feature_Container_Dominant_X_Shape( const Feature_Container_Dominant_X_Shape& other ) : Feature( other ),
...
/**
 * Feature_Container_Dominant_X_Shape class destructor
 */
Feature_Container_Dominant_X_Shape::
~Feature_Container_Dominant_X_Shape() {
...
/** 
 * Feature_Container_Dominant_X_Shape class assignment operator
 */
Feature_Container_Dominant_X_Shape&
Feature_Container_Dominant_X_Shape::
operator=( const Feature_Container_Dominant_X_Shape& other ){
...
/**
 * Returns bool if the concept has dominant structure along the x axis. .
 * Note: row is along the x-axis (=ve x going front of the robot.)
    ...
    if( root->type == XML_ELEMENT_NODE ){
      ...
      for( l1 = root->children; l1; l1 = l1->next ){
        if( l1->type == XML_ELEMENT_NODE ){
          if( xmlStrcmp( l1->name, ( const xmlChar* )( "feature_container_dominant_x_shape" ) ) == 0 ){
            from_xml( l1 );
          }
        }
      }
...
/** 
 * imports the Feature_Container_Dominant_X_Shape class from an XML node pointer
 */
void
Feature_Container_Dominant_X_Shape::
...
/**
 * exports the Feature_Container_Dominant_X_Shape class to an XML file
 */
void
Feature_Container_Dominant_X_Shape::
...
/**
 * exports the Feature_Container_Dominant_X_Shape class to an XML node pointer
 */
void
Feature_Container_Dominant_X_Shape::
to_xml( xmlDocPtr doc,
        xmlNodePtr root )const{
  xmlNodePtr node = xmlNewDocNode( doc, NULL, ( xmlChar* )( "feature_container_dominant_x_shape" ), NULL );
...
namespace h2sl {
  ...
  operator<<( ostream& out,
              const Feature_Container_Dominant_X_Shape& other ){
     out << "class:\"Feature_Container_Dominant_X_Shape\" ";
