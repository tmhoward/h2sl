...
int main( int argc, char* argv[] ){
  ...
  auto np0 = std::make_shared<h2sl::LanguageVariable>("NP");
  np0->words = std::make_optional< std::vector<h2sl::Word> >();
  ...
  auto pp0 = std::make_shared<h2sl::LanguageVariable>("PP");
  pp0->words = std::make_optional< std::vector<h2sl::Word> >();
  ...
  auto vp0 = std::make_shared<h2sl::LanguageVariable>("VP");
  vp0->words = std::make_optional< std::vector<h2sl::Word> >();
  ...
  auto whnp1 = std::make_shared<h2sl::LanguageVariable>("WHNP");
  whnp1->words = std::make_optional< std::vector<h2sl::Word> >();
  ...
  auto np2 = std::make_shared<h2sl::LanguageVariable>("NP");
  np2->words = std::make_optional< std::vector<h2sl::Word> >();
  ...
  if (vm.count("input")) {
    ...
    dialogue.from_file(vm["input"].as<std::string>(), symbolspace );
  }
